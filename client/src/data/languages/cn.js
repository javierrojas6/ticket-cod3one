export default {
  ...
  CREATE_TICKET_DESCRIPTION:
    '這是一個用於創建票證的表單。填寫表格並將您的問題/疑問/建議發送給我們。我們的支持系統將盡快回答。',
  ...
  EMAIL_TEMPLATES_DESCRIPTION:
    "在這裡，您可以編輯將發送給用戶的電子郵件的模板。請記住，雙括號花括號表示一個變量值。例如，'名稱 '表示用戶名。",
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    '啟用/禁用用戶系統的使用。如果你禁用它，所有的用戶將被刪除，但票將被保留。如果啟用，將創建現有票證的用戶。',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    '在这里，你可以邀请一个用户加入我们的支持系统，他将只需要提供自己的密码，以创建一个新用户。',
  ERROR_NAME: '名稱無效',
