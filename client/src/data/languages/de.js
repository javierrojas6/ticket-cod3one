export default {
  ...
  LEVEL_2_DESCRIPTION:
    'Kann alles aus Stufe 1, kann Artikel erstellen oder bearbeiten und benutzerdefinierte Antworten erstellen.',
  LEVEL_3_DESCRIPTION:
    'Kann alles aus Stufe 2, kann Mitarbeiter erstellen oder bearbeiten und kann das gesamte System verwalten.',
  ...
  INSTALL_HEADER_DESCRIPTION:
    'Dieser Assistent hilft Ihnen bei der Konfiguration und Installation von OpenSupports auf Ihrer Website.',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Bitte merken Sie sich dieses Passwort. Es ist für den Zugriff auf das Admin-Panel erforderlich. Sie können es später ändern.',
  INSTALLATION_COMPLETED: 'Installation abgeschlossen.',
  INSTALLATION_COMPLETED_DESCRIPTION:
    'Die Installation von OpenSupports ist abgeschlossen. Umleitung zum Admin-Panel...',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Dies ist ein Formular für die Erstellung von Tickets. Füllen Sie das Formular aus und senden Sie uns Ihre Fragen/Anregungen. Unser Support-System wird Ihnen so schnell wie möglich antworten.',
  TICKET_LIST_DESCRIPTION: 'Hier finden Sie eine Liste aller Tickets, die Sie an unser Support-Team gesendet haben.',
  TICKETS_DESCRIPTION:
    'Senden Sie das Ticket über unser Support-Center und erhalten Sie Antworten auf Ihre Zweifel, Anregungen und Fragen.',
  ARTICLES_DESCRIPTION:
    'Werfen Sie einen Blick auf unsere Artikel über gemeinsame Themen, Leitfäden und Dokumentation.',
  ACCOUNT_DESCRIPTION:
    'Alle Ihre Tickets werden im Profil Ihres Kontos gespeichert. Verfolgen Sie alle Ihre Tickets während ihrer Bearbeitung.',
  SUPPORT_CENTER_DESCRIPTION:
    'Willkommen in unserem Support-Center. Sie können uns über ein Ticketsystem kontaktieren. Ihre Tickets werden von unseren Mitarbeitern beantwortet.',
  ...
  CUSTOM_TAGS_DESCRIPTION:
    'Hier können Sie die benutzerdefinierten Tags für Tickets verwalten, um sie besser identifizieren zu können',
  ...
  TICKET_VIEW_DESCRIPTION:
    'Dieses Ticket wurde von einem Kunden gesendet. Hier können Sie das Ticket beantworten oder zuordnen',
  BAN_USERS_DESCRIPTION:
    'Hier können Sie eine Liste der verbotenen E-Mail-Adressen sehen, Sie können sie aufheben oder weitere E-Mail-Adressen hinzufügen.',
  LIST_USERS_DESCRIPTION:
    'Dies ist die Liste der Benutzer, die in dieser Plattform registriert sind. Sie können nach jemandem insbesondere suchen, löschen oder sperren.',
  ...
  DELETE_USER_DESCRIPTION:
    'Der Benutzer kann sich nicht anmelden, und alle Tickets werden gelöscht. Außerdem kann die E-Mail-Adresse nicht mehr verwendet werden.',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'Hier können Sie einen Artikel hinzufügen, der für jeden Benutzer verfügbar ist. Es wird innerhalb der Kategorie {category} hinzugefügt werden.',
  LIST_ARTICLES_DESCRIPTION:
    'Dies ist eine Liste von Artikeln, die Informationen über unsere Dienstleistungen enthält.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Eine Abteilung ist eine Gruppe, in der die Tickets gehen können. Sie werden verwendet, um die Tickets zu kategorisieren. Sie können sie anderen Mitarbeitern zuordnen.',
  MAINTENANCE_MODE_DESCRIPTION:
    'Das System befindet sich im Wartungsmodus und ist zur Zeit nicht verfügbar. Wir kommen so schnell wie möglich wieder.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Hier können Sie die Vorlagen der E-Mails bearbeiten, die an Benutzer gesendet werden. Beachten Sie, dass die geschweiften Klammern der doppelten Klammern einen variablen Wert angeben. Beispiel: 'name' steht für den Namen des Benutzers.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Hier können Sie die erweiterten Einstellungen Ihres Systems ändern. Bitte seien Sie vorsichtig, da die Änderungen die Sie machen nicht rückgängig gemacht werden.',
  ...
  EDIT_PROFILE_VIEW_DESCRIPTION:
    'Hier können Sie Ihr Profil bearbeiten, indem Sie Ihre E-Mail-Adresse oder Ihr Passwort ändern.',
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Aktivieren/deaktivieren Sie die Verwendung eines Benutzersystems. Wenn Sie es deaktivieren, werden alle Benutzer gelöscht, aber die Tickets werden behalten. Wenn Sie es aktivieren, werden die Benutzer der vorhandenen Tickets erstellt.',
  CSV_DESCRIPTION:
    'Die CSV-Datei muss 3 Spalten haben: E-Mail-Adresse, Passwort, Name. Es gibt kein Limit in der Zeilenzahl. Es wird ein Benutzer pro Zeile in der Datei erstellt.',
  SMTP_SERVER_DESCRIPTION:
    'Die Konfiguration des SMTP-Servers ermöglicht es der Software, Mails zu senden. Wenn Sie es nicht konfigurieren, werden keine E-Mails von OpenSupports gesendet.',
  IMAP_SERVER_DESCRIPTION:
    'Die Konfiguration des IMAP-Servers ermöglicht es der Anwendung, Tickets aus den an ein Postfach gesendeten E-Mails zu erstellen.',
  ...
  EMAIL_SETTINGS_DESCRIPTION:
    'Hier können Sie die Einstellungen für das Empfangen und Senden von E-Mails an Ihre Kunden bearbeiten.',
  IMAP_POLLING_DESCRIPTION:
    'Die Posteingangsüberprüfung wird von OpenSupports nicht automatisch durchgeführt. Sie müssen regelmäßig POST-Anfragen an diese URL stellen, um die E-Mails zu verarbeiten: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Hier können Sie ein benutzerdefiniertes Feld für einen Benutzer erstellen. Dies kann ein leeres Textfeld oder ein fester Satz von Optionen sein.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Benutzerdefinierte Felder sind zusätzliche Felder, die Benutzer ausfüllen können, um weitere Informationen zu ihnen bereitzustellen.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Hier können Sie einen Benutzer einladen, unser Support-System zu verbinden, wird er braucht nur sein Passwort, um einen neuen Benutzer zu erstellen.',
  ...
  DEPARTMENT_PRIVATE_TICKETS:
    'Diese Abteilung hat Tickets, die von Nicht-Mitarbeitern erstellt wurden, und kann nicht privat sein',
