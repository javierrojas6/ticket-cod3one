export default {
  ...
  LEVEL_2_DESCRIPTION:
    "Her Seviye 1'i yapabilir, yazı oluşturabilir veya düzenleyebilir ve özel yanıtlar oluşturabilir.",
  LEVEL_3_DESCRIPTION:
    "Her Düzey 2'yi yapabilir, personel üyeleri oluşturabilir veya düzenleyebilir ve tüm sistemi yönetebilirsiniz.",
  ...
  INSTALL_HEADER_DESCRIPTION:
    "Bu sihirbaz web sitenize OpenSupports'u yapılandırmanıza ve kurmanıza yardımcı olacaktır.",
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Lütfen bu şifreyi hatırlayın. Yönetici paneline erişmek için gereklidir. Daha sonra değiştirebilirsiniz.',
  ...
  STEP_2_DESCRIPTION:
    'Aşağıda, OpenSupports çalıştırma gereksinimleri listelenmiştir. Lütfen tüm gereksinimlerin karşılandığından emin olun.',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Bu, bir bilet oluşturmak için kullanılan bir form. Formu doldurun ve bize sorunlarınızı / şüphelerinizi / önerileri gönderin. Destek sistemimiz mümkün olan en kısa zamanda cevaplayacaktır.',
  ...
  ACCOUNT_DESCRIPTION:
    'Tüm biletler hesabınızın profilinde saklanır. Personel ekibinize gönderdiğiniz tüm biletlerinizi takip edin.',
  SUPPORT_CENTER_DESCRIPTION:
    'Destek merkezimize hoş geldiniz. Bir bilet sistemi aracılığıyla bizimle iletişime geçebilirsiniz. Biletleriniz personelimiz tarafından cevaplandırılacaktır.',
  ...
  TICKET_VIEW_DESCRIPTION:
    'Bu bilet bir müşteri tarafından gönderilmiştir. Buraya cevap verebilir veya bilet atayabilirsin',
  BAN_USERS_DESCRIPTION:
    'Burada yasaklı e-postaların bir listesini görebilir, bunları yasaklayabilir veya listeye daha fazla e-posta ekleyebilirsiniz.',
  LIST_USERS_DESCRIPTION:
    'Bu, bu platformda kayıtlı olan kullanıcıların listesi. Özellikle birisini arayabilir, silebilir veya yasaklayabilirsiniz.',
  USER_VIEW_DESCRIPTION:
    'Burada bir kullanıcı hakkında tüm bilgileri ve kullanıcı tarafından gönderilen tüm biletleri bulabilirsiniz. Ayrıca silebilir veya yasaklayabilirsiniz.',
  DELETE_USER_DESCRIPTION:
    'Kullanıcı yaşlanmaya giriş yapamaz ve tüm biletleri silinir. Ayrıca, e-posta artık kullanılamaz.',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'Burada, her kullanıcı için hazır olacak bir makale ekleyebilirsiniz. {Category} kategorisine eklenecektir.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Bir bölüm, biletleri gidebilecek bir gruptur. Biletleri kategorize etmek için kullanılırlar. Onları diğer çalışanlara atayabilirsiniz.',
  MAINTENANCE_MODE_DESCRIPTION:
    'Destek sistemi bakım modundadır, bu nedenle şu an kullanılamamaktadır. Mümkün olduğunca çabuk döneceğiz.',
  EMAIL_TEMPLATES_DESCRIPTION:
    " Burada, kullanıcılara gönderilecek e-postaların şablonlarını düzenleyebilirsiniz. Çift parantez kaşlı parantezlerin değişken bir değeri gösterdiğini unutmayın. Örneğin, 'ad' kullanıcının adını belirtir.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Burada sisteminizin gelişmiş ayarlarını değiştirebilirsiniz. Lütfen dikkatli olun, yaptığınız değişiklikler iptal edilemez.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Burada, destek merkezimiz için bir hesap oluşturabilirsiniz. Bilet göndermek ve belgeleri görmek için gereklidir.',
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Bir kullanıcı sisteminin kullanımını etkinleştirir / devre dışı bırakır. Devre dışı bırakırsanız, tüm kullanıcılar silinir ancak biletler muhafaza edilir. Etkinleştirirseniz, mevcut biletler kullanıcıları oluşturulur.',
  CSV_DESCRIPTION:
    'CSV dosyasının 3 sütun olması gerekir: e-posta, şifre, ad. Satır sayısı sınırı yoktur. Dosya satır başına bir kullanıcı oluşturulur.',
  SMTP_SERVER_DESCRIPTION:
    'SMTP sunucusunun yapılandırması, uygulamanın postalar göndermesine izin verir. Onu yapılandırmazsanız, OpenSupports tarafından hiçbir e-posta gönderilmeyecektir',
  IMAP_SERVER_DESCRIPTION:
    'IMAP sunucusunun yapılandırması, uygulamanın bir posta kutusuna gönderilen e-postalardan bilet oluşturmasına izin verir.',
  ...
  IMAP_POLLING_DESCRIPTION:
    "Gelen kutusu kontrolü, OpenSupports tarafından otomatik olarak yapılmayacaktır. E-postaları işlemek için bu url'ye düzenli aralıklarla POST istekleri yapmanız gerekir: {url}",
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Burada bir kullanıcı için özel bir alan oluşturabilirsiniz, boş bir metin kutusu veya sabit bir seçenek kümesi olabilir.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Özel alanlar, kullanıcıların onlar hakkında daha fazla bilgi sağlamak için doldurabilecekleri ek alanlar olarak tanımlanır.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Burada bizim destek sistemi katılmak için bir kullanıcıyı davet edebilirsiniz, o sadece yeni bir kullanıcı oluşturmak için onun şifrelerini vermesi gerekecektir.',
  ...
  DEPARTMENT_PRIVATE_TICKETS:
    'Bu departman, personel olmayanlar tarafından oluşturulan biletlere sahiptir ve özel olamaz',
