export default {
  ...
  LEVEL_2_DESCRIPTION:
    'può solo rispondere ai ticket e gestire gli utenti, può creare o modificare articoli e può creare risposte personalizzate.',
  LEVEL_3_DESCRIPTION:
    "può solo rispondere ai ticket e gestire gli utenti, può creare o modificare articoli e può creare risposte personalizzate, può creare o modificare i membri del personale e gestire l'intero sistema.",
  ...
  INSTALL_HEADER_DESCRIPTION:
    'Questa procedura guidata ti aiuterà a configurare e installare OpenSupport sul tuo sito web',
  ...
  INSTALLATION_COMPLETED_DESCRIPTION:
    "L'installazione di OpenSupports è completata. Reindirizzamento al pannello di controllo...",
  ...
  STEP_2_DESCRIPTION:
    "Ecco elencati i requisiti per l'esecuzione di OpenSupports. Assicurati che tutti i requisiti siano soddisfatti.",
  ...
  SUPPORT_CENTER_DESCRIPTION:
    'Benvenuto nel nostro centro assistenza. Puoi contattarci creando un ticket, il nostro staff ti risponderà al più presto. .',
  ...
  USER_VIEW_DESCRIPTION:
    "Qui puoi trovare tutte le informazioni su un utente e tutti i ticket inviati dall'utente. Puoi anche eliminarlo o bannare.",
  ...
  EMAIL_TEMPLATES_DESCRIPTION:
    "Qui puoi modoficare i modelli delle email che verranno inviate agli utenti. Ricorda che le doppie brackets curly braces indicano un valore variabile. Ad esempio, 'name' rappresenta il 'nome ' dell'utente.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Qui puoi modificare le impostazioni avanzate del tuo sistema. Attenzione, le modifiche apportate non possono essere invertite.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    "Qui puoi creare un account per il nostro centro di supporto. È richiesto per i l'invio dei ticket e per la consultazione della documentazione.",
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    "Abilita / disabilita l'utilizzo di un sistema utente. Se lo disattiverai, tutti gli utenti verranno eliminati ma i biglietti saranno conservati. Se lo abiliterai, verranno creati gli utenti dei biglietti esistenti.",
  CSV_DESCRIPTION:
    'l file CSV deve avere 3 colonne: e-mail, password, nome. Non esiste alcun limite nel conteggio delle righe. Sarà creato un utente per riga nel file.',
  SMTP_SERVER_DESCRIPTION:
    "La configurazione del server SMTP consente all'applicazione di inviare messaggi. Se non lo si configura, non verrà inviata alcuna email da OpenSupports.",
  IMAP_SERVER_DESCRIPTION:
    "La configurazione del server IMAP consente all'applicazione di creare ticket dalle e-mail inviate a una casella di posta.",
  ...
  IMAP_POLLING_DESCRIPTION:
    'Il controllo della posta in arrivo non verrà eseguito automaticamente da OpenSupports. Devi effettuare periodicamente richieste POST a questo URL per elaborare le email: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Qui puoi creare un campo personalizzato per un utente, può essere una casella di testo vuota o un set fisso di opzioni.',
  CUSTOM_FIELDS_DESCRIPTION:
    'I campi personalizzati sono campi aggiuntivi definiti che gli utenti possono compilare per fornire maggiori informazioni su di essi.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Qui è possibile invitare un utente ad entrare il nostro sistema di supporto, avrà solo bisogno di fornire la propria password per creare un nuovo utente.',
  ...
  ERROR_RETRIEVING_BAN_LIST:
    "Si è verificato un errore durante il tentativo di recuperare l'elenco delle email non autorizzate.",
  ...
  WILL_DELETE_DEPARTMENT:
    'Il dipartimento verrà cancellato. Tutti i ticket saranno trasferiti al dipartimento selezionato.',
  ...
  INSTANT: 'Immediato',
  INSTANT_DESCRIPTION:
    'Percentuale di ticket chiusi dopo una singola risposta del personale sul totale dei ticket chiusi',
  REOPENED: 'Riaperto',
  ...
  SUNDAY: 'Domenica',
  TICKET_NUMBER_SENT:
    "Il biglietto è stato creato con successo ed è stata inviata un'e-mail con il numero del biglietto.",
