export default {
  ...
  LEVEL_2_DESCRIPTION:
    'Pode fazer o que o nível 1 faz e pode criar ou editar artigos e pode criar respostas customizadas.',
  LEVEL_3_DESCRIPTION:
    'Pode fazer o que o nível 2 faz e pode criar ou editar membros da equipe e pode gerenciar todo o sistema.',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Este é um formulário abrir um chamado. Preencha o formulário e envie-nos seus problemas / dúvidas / sugestões. Nosso suporte responderá o mais rápido possível.',
  TICKET_LIST_DESCRIPTION:
    'Aqui você pode encontrar uma lista de todos os chamados enviados para nossa equipe de suporte.',
  TICKETS_DESCRIPTION:
    'Abra o seu chamado através do nosso centro de suporte e obtenha resposta das suas dúvidas, sugestões e problemas.',
  ARTICLES_DESCRIPTION: 'Dê uma olhada em nossos artigos sobre questões comuns, guias e documentação.',
  ACCOUNT_DESCRIPTION:
    'Todos os seus chamados são guardados no perfil da sua conta. Mantemos um registo de todos os chamados que você abriu conosco.',
  SUPPORT_CENTER_DESCRIPTION:
    'Bem-vindo ao nosso centro de suporte. Pode contactar-nos através da abertura de chamados. Os seus chamados serão respondidos pela nossa equipe.',
  ...
  BAN_USERS_DESCRIPTION:
    'Aqui você pode ver uma lista de e-mails banidos, você pode desbaní-los ou adicionar mais e-mails para a lista.',
  ...
  USER_VIEW_DESCRIPTION:
    'Aqui você pode encontrar todas as informações sobre um usuário e todos os chamados abertos por ele. Você também pode excluir ou banir.',
  DELETE_USER_DESCRIPTION:
    'O usuário não será capaz de entrar no sistema e todos os seus chamados serão apagados. Além disso, o e-mail não poderá mais ser usado.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Um departamento é um grupo de atendimento de chamados. Eles são usados para categorizar os chamados. Você pode atribuí-los a outros membros da equipe.',
  MAINTENANCE_MODE_DESCRIPTION:
    'O sistema de suporte está em modo de manutenção, portanto indisponível no momento. Voltamos em alguns minutos.',
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Ativar / desativar o uso de um sistema de usuário. Se você desativá-lo, todos os usuários serão excluídos, mas os chamados serão mantidos. Se você ativá-lo, os chamados de usuários existentes serão criados.',
  CSV_DESCRIPTION:
  ...
  IMAP_SERVER_DESCRIPTION:
    'A configuração do servidor IMAP permite que o aplicativo crie chamados a partir dos emails enviados para uma caixa de correio.',
  ...
  WILL_DELETE_DEPARTMENT:
    'O departamento será excluído. Todos os chamados serão transferidos para o departamento selecionado.',
