export default {
  ...
  LEVEL_3_DESCRIPTION:
    'może to samo, co poziom 2, a także tworzyć i edytować członków personelu oraz zarządzać całym systemem.',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Zapamiętaj to hasło. Będzie ono potrzebne, by zalogować się do panelu administracyjnego. Można je później zmienić.',
  INSTALLATION_COMPLETED: 'Instalacja zakończona.',
  INSTALLATION_COMPLETED_DESCRIPTION:
    'Instalacja OpenSupports została zakończona. Przekierowanie do panelu administracyjnego...',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Oto formularz zgłoszenia. Opisz w nim swój problem lub podziel się obawami/spostrzeżeniami. Odpowiemy na Twoje zgłoszenie najszybciej jak się da.',
  TICKET_LIST_DESCRIPTION: 'Tu znajdziesz listę wszystkich swoich zgłoszeń, które zostały nam przesłane.',
  TICKETS_DESCRIPTION:
    'Wyślij zgłoszenie z opisem swojego problemu i otrzymaj odpowiedź poprzez nasze centrum wsparcia.',
  ARTICLES_DESCRIPTION:
    'Przejrzyj artykuły na temat najczęściej występujących problemów, porady, przewodniki i dokumentacje.',
  ACCOUNT_DESCRIPTION:
    'Tu możesz przejrzeć wszystkie swoje zgłoszenia i na bieżąco sprawdzać, czy zgłoszone problemy zostały już rozwiązane.',
  SUPPORT_CENTER_DESCRIPTION:
    'Witaj w naszym centrum wsparcia. Możesz skontaktować się z nami poprzez system zgłoszeń. Nasz personel odpowie na Twoje zgłoszenia.',
  ...
  TICKET_VIEW_DESCRIPTION:
    'To zgłoszenie zostało przysłane przez klienta. Tu można je przypisać lub na nie odpowiedzieć.',
  BAN_USERS_DESCRIPTION:
    'Tu możesz zobaczyć listę zbanowanych adresów email, możesz je odbanować lub dodać więcej adresów do listy.',
  LIST_USERS_DESCRIPTION:
    'Oto lista zarejestrowanych użytkowników. Możesz wyszukiwać użytkowników, usuwać ich lub banować.',
  USER_VIEW_DESCRIPTION:
    'Tu możesz sprawdzić informacje o użytkowniku, a także jego zgłoszenia. Możesz także zbanować lub usunąć użytkownika.',
  DELETE_USER_DESCRIPTION:
    'Użytkownik nie będzie mógł się zalogować, a jego zgłoszenia zostaną usunięte. Adres email tego użytkownika zostanie zbanowany i nie będzie mógł być użyty do ponownej rejestracji.',
  DELETE_TOPIC_DESCRIPTION:
    'Jeśli usuniesz ten temat, to wszystkie artykuły w nim zgromadzone również zostaną usunięte.',
  EDIT_TOPIC_DESCRIPTION: 'Tu możesz zmienić nazwę, ikonę i jej kolor dla tego tematu.',
  ADD_ARTICLE_DESCRIPTION:
    'Tu możesz dodać artykuł dostępny dla każdego użytkownika. Zostanie od dodany do kategorii {category}.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Dział jest jednostką organizacyjną, do której zgłoszenia mogą być przypisane. Działy służą do kategoryzacji zgłoszeń i mogą być przydzielone różnym członkom personelu.',
  MAINTENANCE_MODE_DESCRIPTION:
    'Centrum wsparcia pracuje w trybie konserwacji, więc obecnie jest niedostępne. Wrócimy tak szybko, jak to będzie możliwe.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Tu możesz edytować szablony emaili, które będą wysyłane do użytkowników. Pamiętaj o podwójnych nawiasach klamrowych, które oznaczają wartość zmienną. Na przykład 'name' oznacza nazwę użytkownika.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Tu możesz zmieniać zaawansowane ustawienia systemu. Zachowaj ostrożność, wprowadzonych zmian nie można cofnąć.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Tu możesz utworzyć konto w naszym centrum wsparcia. Jest ono wymagane do wysyłania zgłoszeń i dostępu do bazy artykułów oraz dokumentacji.',
  EDIT_PROFILE_VIEW_DESCRIPTION: 'Tu możesz zmienić swoje dane, w tym email i hasło.',
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Włącz/Wyłącz system użytkowników. Jeśli wyłączysz system użytkowników, to wszyscy użytkownicy zostaną usunięci, ale ich zgłoszenia zachowane. Jeśli go ponownie włączysz, to użytkownicy istniejących zgłoszeń zostaną ponownie utworzeni.',
  CSV_DESCRIPTION:
    'Plik CSV musi posiadać 3 kolumny: email, hasło i nazwę. Nie ma limitu w liczbie wierszy. Każdy wiersz odpowiada za utworzenie jednego użytkownika.',
  SMTP_SERVER_DESCRIPTION:
    'Konfiguracja serwera SMTP pozwala na automatyczne wysyłanie emaili z powiadomieniami do użytkowników i członków personelu. Jeśli nie skonfigurujesz serwera SMTP, OpenSupports nie będzie wysyłał emaili.',
  IMAP_SERVER_DESCRIPTION:
    'Konfiguracja serwera IMAP umożliwia aplikację do tworzenia bilety od e-maili wysyłanych do skrzynki pocztowej.',
  ...
  IMAP_POLLING_DESCRIPTION:
    'Sprawdzanie skrzynki odbiorczej nie zostaną wykonane automatycznie przez OpenSupports. Trzeba uczynić żądania POST okresowo do tego adresu URL do przetwarzania wiadomości e-mail: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Tutaj można utworzyć pole niestandardowe dla użytkownika może być puste pole tekstowe lub stały zestaw opcji.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Pola niestandardowe zdefiniowane są dodatkowe pola użytkownicy są w stanie wypełnić, aby dostarczyć więcej informacji na ich temat.',
  ...
  WILL_DELETE_STAFF:
    'Ten członek personelu zostanie usunięty, a wszystkie należące do niego zgłoszenia zostaną bez opiekuna.',
  ...
  INSTANT_DESCRIPTION:
    'Odsetek biletów zamkniętych po odpowiedzi jednego pracownika w stosunku do łącznej liczby zamkniętych biletów',
  REOPENED: 'Ponownie otwarty',
  REOPENED_DESCRIPTION:
    'Procent biletów, które zostały ponownie otwarte w stosunku do łącznej liczby utworzonych biletów',
  MONDAY: 'Poniedziałek',
  TUESDAY: 'Wtorek',
  WEDNESDAY: 'Środa',
  THURSDAY: 'Czwartek',
