export default {
  ...
  LEVEL_3_DESCRIPTION:
    "En plus du niveau 2, peut créer ou modifier des membres de l'administration et gérer l'ensemble du système.",
  ...
  SUPPORTED_LANGUAGES_INFO:
    'Les langues prises en charge sont les langues dans lesquelles les tickets peuvent être écrits.',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    "Ne perdez pas ce mot de passe. Il est nécessaire pour accéder au panel d'administration. Vous pourrez le modifier ultérieurement.",
  INSTALLATION_COMPLETED: 'Installation terminée.',
  INSTALLATION_COMPLETED_DESCRIPTION:
    "L'installation d'OpenSupports est terminée. Redirection vers le panel d'administration...",
  ...
  STEP_2_DESCRIPTION:
    'Voici les conditions requises pour exécuter OpenSupports. Assurez-vous que toutes les conditions requises soient satisfaites.',
  ...
  CREATE_TICKET_DESCRIPTION:
    "Il s'agit d'un formulaire de création de tickets. Remplissez le formulaire et envoyez-nous vos questions / doutes / suggestions. Notre système de support répondra le plus rapidement possible.",
  TICKET_LIST_DESCRIPTION:
    "Vous trouverez ici une liste de tous les tickets que vous avez envoyés à notre équipe d'assistance.",
  TICKETS_DESCRIPTION:
    'Envoyez un ticket via notre centre de support et recevez la réponse de vos doutes, suggestions et problèmes.',
  ARTICLES_DESCRIPTION:
    "Jetez un coup d'oeil à nos articles sur les questions courantes, les guides et la documentation.",
  ACCOUNT_DESCRIPTION:
    'Tous vos tickets sont stockés dans le profil de votre compte. Gardez une trace de tous vos tickets que vous envoyez à notre équipe.',
  SUPPORT_CENTER_DESCRIPTION:
    "Bienvenue dans notre centre de support. Vous pouvez nous contacter via un système de tickets. Notre équipe d'assistance répondra à vos tickets.",
  CUSTOM_RESPONSES_DESCRIPTION:
    'Les réponses personnalisées sont des réponses automatisées pour des problèmes courants',
  CUSTOM_TAGS_DESCRIPTION:
    'Ici, vous pouvez voir gérer les étiquettes personnalisées pour les billets pour mieux les identifier',
  ...
  BAN_USERS_DESCRIPTION:
    'Ici, vous pouvez voir la liste des e-mails qui ont été bannis. Vous pouvez en ajouter de nouveaux ou en supprimer de la liste.',
  LIST_USERS_DESCRIPTION:
    "Il s'agit de la liste des utilisateurs enregistrés sur cette plate-forme. Vous pouvez rechercher quelqu'un en particulier, le supprimer ou le bannir.",
  USER_VIEW_DESCRIPTION:
    'Ici vous pouvez trouver toutes les informations sur un utilisateur et tous les tickets envoyés par cet utilisateur. Vous pouvez également le supprimer ou le bannir.',
  DELETE_USER_DESCRIPTION:
    "L'utilisateur ne sera plus en mesure de se connecter et tous ses tickets seront effacés. En outre, le courrier électronique ne pourra plus être utilisé.",
  ...
  ADD_ARTICLE_DESCRIPTION:
    "Ici vous pouvez ajouter un article qui sera disponible pour tous les utilisateurs. Il sera ajouté à l'intérieur de la catégorie {category}.",
  ...
  DEPARTMENTS_DESCRIPTION:
    "Un département est un groupe où les tickets peuvent être assignés. Ils sont utilisés pour catégoriser les tickets. Vous pouvez les assigner à d'autres administrateurs.",
  MAINTENANCE_MODE_DESCRIPTION:
    'Le système de support est en mode maintenance, donc indisponible pour le moment. Nous reviendrons dès que possible.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Ici, vous pouvez modifier les modèles des e-mails qui seront envoyés aux utilisateurs. N'oubliez pas que les doubles accolades indiquent une valeur variable. Par exemple, 'nom' représente le nom de l'utilisateur.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Ici, vous pouvez modifier les paramètres avancés de votre système. Attention, les modifications que vous effectuez sont irréversibles.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Ici, vous pouvez créer un compte pour notre centre de support. Il est nécessaire pour soumettre des tickets et voir la documentation.',
  EDIT_PROFILE_VIEW_DESCRIPTION:
    'Ici, vous pouvez modifier votre utilisateur en changeant votre adresse e-mail ou votre mot de passe.',
  ENABLE_USER_SYSTEM_DESCRIPTION:
    "Activer / désactiver l'utilisation d'un système utilisateur. Si vous le désactivez, tous les utilisateurs seront supprimés, mais les tickets seront conservés. Si vous l'activez, les utilisateurs des tickets existants seront créés.",
  CSV_DESCRIPTION:
    "Le fichier CSV doit comporter 3 colonnes: email, mot de passe, nom. Il n'y a pas de limite dans le nombre de lignes. Il sera créé un utilisateur par ligne dans le fichier.",
  SMTP_SERVER_DESCRIPTION:
    "La configuration du serveur SMTP permet à l'application d'envoyer des mails. Si vous ne le configurez pas, aucun service d'email ne sera envoyé par OpenSupports.",
  IMAP_SERVER_DESCRIPTION:
    'La configuration du serveur IMAP permet à l’application de créer des tickets à partir des emails envoyés à une boîte aux lettres.',
  ...
  LOCK_DEPARTMENT_DESCRIPTION:
    'Permettre aux utilisateurs de créer des billets uniquement dans le département par défaut',
  ...
  EMAIL_SETTINGS_DESCRIPTION:
    'Ici, vous pouvez modifier les paramètres de réception et d’envoi de courrier électronique à vos clients.',
  IMAP_POLLING_DESCRIPTION:
    'La vérification de la boîte de réception ne sera pas effectuée automatiquement par OpenSupports. Vous devez faire des demandes POST périodiquement à cette URL pour traiter les emails: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    "Ici, vous pouvez créer un champ personnalisé pour un utilisateur. Il peut s'agir d'une zone de texte vide ou d'un ensemble fixe d'options.",
  CUSTOM_FIELDS_DESCRIPTION:
    'Les champs personnalisés sont des champs supplémentaires que les utilisateurs peuvent remplir pour fournir plus d\informations à leur sujet.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Ici, vous pouvez inviter un utilisateur à se joindre à notre système de soutien, il juste besoin de fournir son mot de passe pour créer un nouvel utilisateur.',
  ...
  DEPARTMENT_PRIVATE_TICKETS:
    'Ce service a des tickets créés par des non-membres du personnel et il ne peut pas être privé',
  ...
  WILL_DELETE_DEPARTMENT:
    'Le département sera supprimé. Tous les tickets seront transférés au département sélectionné.',
  ...
  WILL_RECOVER_EMAIL_TEMPLATE:
    'Ce modèle de courrier électronique sera réinitialisé à sa valeur par défaut pour cette langue.',
  ...
  INSTANT: 'Instant',
  INSTANT_DESCRIPTION:
    'Pourcentage de tickets fermés après une seule réponse du personnel sur le total des tickets fermés',
  REOPENED: 'Rouverte',
