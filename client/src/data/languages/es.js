export default {
  ...
  LEVEL_2_DESCRIPTION:
    'Puede hacer lo mismo que el Nivel 1, y además, crear o editar artículos y crear respuestas personalizadas.',
  LEVEL_3_DESCRIPTION:
    'Puede hacer lo mismo que el nivel 2, además, crear o editar miembros del staff y gestionar todo el sistema.',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Por favor, recuerde esta contraseña. Es necesaria para acceder al panel de administración. Puedes cambiarla después.',
  ...
  STEP_2_DESCRIPTION:
    'Aqui están listados los requisitos para OpenSupports. Por favor, asegúrese de cumplir con todos los requisitos.',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Este es un formulario para crear tickets. Rellene el formulario y envíenos sus dudas. Nuestro sistema de soporte responderá lo antes posible.',
  TICKET_LIST_DESCRIPTION:
    'Aquí puede encontrar una lista de todos los tickets que ha enviado a nuestro equipo de soporte.',
  TICKETS_DESCRIPTION:
    'Envíe un ticket a través de nuestro centro de soporte y obtenga respuesta de sus dudas, sugerencias o problemas.',
  ARTICLES_DESCRIPTION: 'Eche un vistazo a nuestros artículos sobre temas comunes, guías y documentación.',
  ACCOUNT_DESCRIPTION:
    'Todos sus tickets están almacenados en el perfil de su cuenta. Mantenga un registro de todos los tickets envíados a nuestro equipo de soporte.',
  SUPPORT_CENTER_DESCRIPTION:
    'Bienvenido a nuestro centro de soporte. Puede ponerse en contacto con nosotros a través de un sistema de tickets. Sus tickets serán contestados por nuestro personal.',
  ...
  CUSTOM_TAGS_DESCRIPTION:
    'Aquí puede ver y administrar las etiquetas personalizadas de los tickets para identificarlos mejor',
  ...
  BAN_USERS_DESCRIPTION:
    'Aquí puede ver la lista de email bloqueados. Puede desbloquear o agregar más emails a la lista.',
  LIST_USERS_DESCRIPTION:
    'Esta es la lista de usuarios que están registrados en el sistema. Puede buscar a alguien en particular, bloquearlo o borralo.',
  USER_VIEW_DESCRIPTION:
    'Aquí puede encontrar toda la información sobre un usuario y todos los tickets enviados por el usuario. También puede eliminarlo o bloquearlo.',
  DELETE_USER_DESCRIPTION:
    'El usuario no podrá iniciar sesión y todos sus tickets se borrarán. Además, el correo electrónico ya no puede utilizarse.',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'Aquí puede agregar un artículo que estará disponible para cada usuario. Se agregará dentro de la categoría {category}.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Un departamento es un grupo donde los tickets pueden ir. Se utilizan para categorizar los tickets. Puede asignarlos a otros miembros de staff.',
  MAINTENANCE_MODE_DESCRIPTION:
    'El sistema de soporte está en modo de mantenimiento, por lo tanto, no está disponible en este momento. Volveremos tan pronto como sea posible.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Aquí puede editar las plantillas de los correos electrónicos que se enviarán a los usuarios. Recuerde que los soportes dobles entrelazados indican un valor variable. Por ejemplo, 'nombre' representa el nombre del usuario.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Aquí puede cambiar la configuración avanzada de su sistema. Tenga cuidado, los cambios que realice no se pueden revertir.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Aquí puede crear una cuenta para nuestro centro de soporte. Es necesario para enviar tickets y ver la documentación.',
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Habilitar/Deshabilitar el uso de un sistema de usuario. Si lo deshabilita, todos los usuarios serán eliminados pero los tickets serán guardados. Si lo habilita, se crearán los usuarios de los tickets existentes.',
  CSV_DESCRIPTION:
    'El archivo CSV debe tener 3 columnas: correo electrónico, contraseña, nombre. No hay límite en el recuento de filas. Se creará un usuario por fila en el archivo.',
  SMTP_SERVER_DESCRIPTION:
    'La configuración de SMTP permite que la aplicación envíe emails. Si no es configurado, ningún mail será enviado por OpenSupports.',
  IMAP_SERVER_DESCRIPTION:
    'La configuración del servidor IMAP permite que la aplicación cree tickets de los correos electrónicos enviados a un buzón.',
  ...
  EMAIL_SETTINGS_DESCRIPTION:
    'Aquí puede editar la configuración para recibir y enviar correos electrónicos a sus clientes.',
  IMAP_POLLING_DESCRIPTION:
    'La verificación de la bandeja de entrada no se hará automáticamente por OpenSupports. Debe realizar solicitudes POST periódicamente a esta URL para procesar los correos electrónicos: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Aquí puede crear un campo personalizado para un usuario, puede ser un cuadro de texto en blanco o un conjunto fijo de opciones.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Los campos personalizados son campos adicionales definidos que los usuarios pueden completar para proporcionar más información sobre ellos.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Aquí se puede invitar a un usuario a nuestro sistema de soporte, que sólo tendrá que proporcionar su contraseña para crear una cuenta nueva.',
  ...
  ERROR_RETRIEVING_BAN_LIST:
    'Se ha producido un error al intentar recuperar la lista de correos electrónicos bloqueados.',
  ...
  WILL_DELETE_DEPARTMENT:
    'Se eliminará el departamento. Todos los tickets serán transferidos al departamento seleccionado.',
  ...
  WILL_RECOVER_EMAIL_TEMPLATE:
    'Esta plantilla de correo electrónico se recuperará a su valor predeterminado en este idioma.',
  ...
  INSTANT: 'Instante',
  INSTANT_DESCRIPTION:
    'Porcentaje de tickets cerrados despues de que un solo staff responda sobre el total de tickets cerrados',
  REOPENED: 'Reabierto',
  SUNDAY: 'domingo',
  ...
  SUNDAY: 'Domingo',
  TICKET_NUMBER_SENT:
    'El ticket han sido creado satisfactoriamente y un email con el numero de ticket ha sido enviado.',
