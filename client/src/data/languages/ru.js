export default {
  ...
  LEVEL_2_DESCRIPTION:
    'может сделать каждый 1-й уровень делает, позволяет создавать и редактировать статьи и он может создавать собственные ответы.',
  LEVEL_3_DESCRIPTION:
    'может сделать каждый уровень 2 делает, может создавать или редактировать пользователей, персонала и может управлять всей системой.',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Пожалуйста, запомните этот пароль. Это необходимо для доступа к панели администратора. Вы можете изменить его позже.',
  ...
  STEP_2_DESCRIPTION:
    'Здесь перечислены требования для запуска OpenSupports. Пожалуйста, убедитесь, что все требования выполнены.',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Это форма для создания билетов. Заполните форму и отправьте нам свои вопросы / сомнения / предложения. Наша система поддержки будет ответить на него как можно скорее.',
  TICKET_LIST_DESCRIPTION: 'Здесь вы можете найти список всех билетов отправленных в нашу службу поддержки.',
  TICKETS_DESCRIPTION:
    'Отправить билет через наш центр поддержки и получить ответ ваши сомнения, предложения и вопросы.',
  ARTICLES_DESCRIPTION: 'Посмотрите наши статьи о распространенных проблемах, руководств и документации',
  ACCOUNT_DESCRIPTION:
    'Все ваши билеты хранятся в вашем аккаунте профиль. Следите за всеми вашими билетами вы посылаете в нашу команду сотрудников.',
  SUPPORT_CENTER_DESCRIPTION:
    'Добро пожаловать в наш центр поддержки. Вы можете связаться с нами через систему билетов. Ваши билеты будут отвечать нашим персоналом.',
  CUSTOM_RESPONSES_DESCRIPTION: 'Пользовательские ответы автоматизированные ответы для общих проблем',
  CUSTOM_TAGS_DESCRIPTION:
    'Здесь вы можете просмотреть управление пользовательскими тегами для заявок, чтобы лучше их идентифицировать',
  ...
  BAN_USERS_DESCRIPTION:
    'Здесь вы можете увидеть список запрещенных писем, вы можете снять запрет их или добавить больше электронных писем в список.',
  LIST_USERS_DESCRIPTION:
    'Это список пользователей, зарегистрированных в этой платформе. Вы можете найти кого-то, в частности, удалить его или запретить его.',
  USER_VIEW_DESCRIPTION:
    'Здесь вы можете найти всю информацию об пользователя, и все билеты, отправленных пользователем. Можно также удалить или запретить его.',
  DELETE_USER_DESCRIPTION:
    'Пользователь не сможет войти в систему старения и все билеты будут стерты. Кроме того, электронная почта не может больше использоваться.',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'Здесь вы можете добавить статью, которая будет доступна для каждого пользователя. Он будет добавлен в категорию {category}.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Отдел представляет собой группу, где билеты можно идти. Они используются для классификации билетов. Вы можете назначить их другим сотрудникам.',
  MAINTENANCE_MODE_DESCRIPTION:
    'Система поддержки находится в режиме обслуживания, таким образом, в данный момент недоступен. Мы вернемся, как можно скорее.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Здесь вы можете редактировать шаблоны писем, которые будут отправлены пользователям. Следует помнить, что двойные скобки, фигурные скобки указывают на значение переменной. Например, ' имя' представляет имя пользователя.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Здесь вы можете изменить дополнительные настройки вашей системы. Пожалуйста, будьте осторожны, изменения, которые вы делаете, не могут быть отменены.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Здесь вы можете создать учетную запись для нашего центра поддержки. Он необходим для отправки билетов и просмотра документации.',
  EDIT_PROFILE_VIEW_DESCRIPTION:
    'Здесь вы можете изменить своего пользователя, изменив свой адрес электронной почты или пароль.',
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Включить / отключить использование пользовательской системы. Если вы отключите его, все пользователи будут удалены. Если вы включите его, будут созданы пользователи существующих билетов.',
  CSV_DESCRIPTION:
    'Файл CSV должен иметь 3 столбца: адрес электронной почты, пароль и имя. Количество строк не ограничено. В файле будет создан один пользователь для каждой строки.',
  SMTP_SERVER_DESCRIPTION:
    'Конфигурация SMTP-сервера позволяет приложению отправлять письма. Если вы не настроите его, никакие электронные письма не будут отправлены OpenSupports.',
  IMAP_SERVER_DESCRIPTION:
    'Конфигурация сервера IMAP позволяет приложению создавать заявки из электронных писем, отправляемых в почтовый ящик.',
  ...
  EMAIL_SETTINGS_DESCRIPTION:
    'Здесь вы можете редактировать настройки для получения и отправки электронной почты своим клиентам.',
  IMAP_POLLING_DESCRIPTION:
    'Проверка входящих сообщений не будет выполняться автоматически OpenSupports. Вы должны периодически отправлять POST-запросы к этому URL для обработки электронных писем: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Здесь вы можете создать настраиваемое поле для пользователя, это может быть пустое текстовое поле или фиксированный набор параметров.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Пользовательские поля определяются дополнительными полями, которые пользователи могут заполнять, чтобы предоставить больше информации о них.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Здесь вы можете пригласить пользователь присоединиться к нашей системе поддержки, он будет просто необходимо предоставить свой пароль, чтобы создать новый пользователь.',
  ...
  WILL_RECOVER_EMAIL_TEMPLATE:
    'Этот шаблон электронной почты будет восстанавливаться, чтобы это значение по умолчанию на этом языке.',
  ...
  INSTANT: 'Мгновенный',
  INSTANT_DESCRIPTION:
    'Процент билетов, закрытых после единственного ответа персонала, по сравнению с общим количеством закрытых билетов',
  REOPENED: 'Снова открыт',
  REOPENED_DESCRIPTION:
    'Процент заявок, которые были повторно открыты, по сравнению с общим количеством созданных заявок',
  MONDAY: 'понедельник',
  TUESDAY: 'вторник',
  WEDNESDAY: 'Cреда',
  THURSDAY: 'четверг',
