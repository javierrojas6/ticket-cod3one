export default {
  ...
  LEVEL_3_DESCRIPTION:
    'Kan alles van niveau 2, kan medewerkers aanmaken en bewerken en kan bij alle systeem opties en instellingen.',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Onthoud dit wachtwoord. Het is nodig voor toegang tot het admin-paneel. Je kunt het later veranderen.',
  INSTALLATION_COMPLETED: 'Installatie voltooid.',
  INSTALLATION_COMPLETED_DESCRIPTION:
    'De installatie van OpenSupports is voltooid. Doorsturen naar beheerderspaneel ...',

  STEP_TITLE: 'Stap {current} van {total} - {title}',
  STEP_1_DESCRIPTION: 'Selecteer de taal van uw voorkeur voor de installatiewizard.',
  STEP_2_DESCRIPTION:
    'Hier zijn de vereisten voor het uitvoeren van OpenSupports vermeld. Zorg ervoor dat aan alle vereisten is voldaan.',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Dit is het formulier voor het maken van incidenten. Vul het formulier in en stuur ons uw problemen / suggesties. Een medewerker zal het zo snel mogelijk beantwoorden.',
  ...
  ACCOUNT_DESCRIPTION:
    'Al uw incidenten worden opgeslagen in het profiel van uw account. Blijf op de hoogte van al uw incidenten die u heeft aangemaakt.',
  SUPPORT_CENTER_DESCRIPTION:
    'Welkom bij ons ondersteuningscentrum. U kunt contact met ons opnemen via een incidentensysteem. Uw incidenten worden door onze medewerkers beantwoord.',
  CUSTOM_RESPONSES_DESCRIPTION:
    'Aangepaste antwoorden zijn geautomatiseerde antwoorden voor veel voorkomende problemen',
  ...
  BAN_USERS_DESCRIPTION:
    'Hier kunt u een lijst met geblokkeerde e-mailadressen zien, u kunt ze deblokkeren of meer e-mailadressen aan de lijst toevoegen.',
  LIST_USERS_DESCRIPTION:
    'Dit is de lijst met gebruikers die op dit platform zijn geregistreerd. U kunt met name iemand zoeken, verwijderen of blokkeren.',
  USER_VIEW_DESCRIPTION:
    'Hier vindt u alle informatie over een gebruiker en alle incidenten die door de gebruiker zijn verzonden. Je kunt hier de gebruiker ook verwijderen of blokkeren.',
  DELETE_USER_DESCRIPTION:
    'De gebruiker kan zich niet opnieuw aanmelden en al zijn incidenten worden gewist. Ook kan het e-mailadres niet meer worden gebruikt.',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'Hier kunt u een artikel toevoegen dat voor elke gebruiker beschikbaar zal zijn. Het wordt toegevoegd binnen de categorie {category}.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Een afdeling is een groep waar de incidenten onder kunnen vallen. Ze worden gebruikt om de incidenten te categoriseren. U kunt deze toewijzen aan andere medewerkers.',
  MAINTENANCE_MODE_DESCRIPTION:
    'Het ondersteuningssysteem bevindt zich op dit moment in de onderhoudsmodus. Even geduld, we zijn snel bij u terug.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Hier kunt u de sjablonen van de e-mails bewerken die naar gebruikers worden verzonden. Vergeet niet dat de accolades met dubbele accolades een variabele waarde aangeven. Bijvoorbeeld, 'name' staat voor de naam van de gebruiker.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Hier kunt u de geavanceerde instellingen van uw systeem wijzigen. Let op, de wijzigingen die u aanbrengt, kunnen niet worden teruggedraaid.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Hier kunt u een account aanmaken voor ons ondersteuningscentrum. Het is vereist voor het aanmaken van incidenten en om artikelen te bekijken.',
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Schakel het gebruik van een gebruikerssysteem in / uit. Als u dit uitschakelt, worden alle gebruikers verwijderd, maar worden de incidenten bewaard. Als u dit inschakelt, worden de gebruikers van bestaande incidenten aangemaakt.',
  CSV_DESCRIPTION:
    'Het CSV-bestand moet drie kolommen bevatten: e-mailadres, wachtwoord, naam. Er is geen limiet in rijtelling. Er wordt één gebruiker per rij in de database gemaakt.',
  SMTP_SERVER_DESCRIPTION:
    'De configuratie van de SMTP-server staat het systeem toe om e-mails te verzenden. Als u deze optie niet configureerd, worden er geen e-mails verzonden door OpenSupports.',
  IMAP_SERVER_DESCRIPTION:
    'Met de configuratie van de IMAP-server kan de applicatie tickets maken van de e-mails die naar een mailbox worden verzonden.',
  ...
  EMAIL_SETTINGS_DESCRIPTION:
    'Hier kunt u de instellingen voor het ontvangen en verzenden van e-mail naar uw klanten bewerken.',
  IMAP_POLLING_DESCRIPTION:
    'Inbox controleren wordt niet automatisch gedaan door OpenSupports. U moet regelmatig POST-verzoeken doen naar deze URL om de e-mails te verwerken: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Hier kunt u een aangepast veld voor een gebruiker maken, dit kan een leeg tekstvak zijn of een vaste reeks opties.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Aangepaste velden zijn extra velden die de gebruikers kunnen invullen om meer informatie over hen te bieden.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Hier kunt u een gebruiker uit te nodigen ons support systeem uit te nodigen, zal hij hoeft alleen maar te zijn wachtwoord om een ​​nieuwe gebruiker aan te maken bieden.',
  ...
  WILL_DELETE_DEPARTMENT:
    'De afdeling wordt verwijderd. Alle incidenten worden overgedragen aan de geselecteerde afdeling.',
  ...
  DELETE_CUSTOM_FIELD_SURE:
    'Sommige gebruikers gebruiken dit veld mogelijk. Weet je zeker dat je het wilt verwijderen?',
  ...
  INSTANT: 'direct',
  INSTANT_DESCRIPTION:
    'Percentage tickets dat is gesloten na een enkele reactie van het personeel ten opzichte van het totaal aantal gesloten tickets',
  REOPENED: 'heropend',
