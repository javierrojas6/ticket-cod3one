export default {
  ...
  VIEW_TICKET_DESCRIPTION:
    'Ελέγξτε την κατάσταση του εισιτηρίου σας χρησιμοποιώντας τον αριθμό του εισιτηρίου και την διεύθυνση ηλεκτρονικού ταχυδρομείου σας.',
  ...
  LEVEL_2_DESCRIPTION:
    'μπορεί να κάνει οτιδήποτε κάνει το Επίπεδο 1, μπορεί να δημιουργήσει ή να επεξεργαστεί άρθρα και μπορεί να δημιουργήσει προσαρμοσμένες απαντήσεις.',
  LEVEL_3_DESCRIPTION:
    'μπορεί να κάνει οτιδήποτε κάνει το Επίπεδο 2, μπορεί να δημιουργήσει ή να επεξεργαστεί τα μέλη του προσωπικού και να διαχειριστεί ολόκληρο το σύστημα.',
  ...
  ALLOWED_LANGUAGES_INFO:
    'Οι επιτρεπόμενες γλώσσες είναι οι γλώσσες οι οποίες μπορούν να χρησιμοποιηθούν από έναν χρήστη.',
  ...
  INSTALL_HEADER_DESCRIPTION:
    'Αυτός ο οδηγός θα σας βοηθήσει να διαμορφώσετε και να εγκαταστήσετε το OpenSupport στον ιστότοπό σας',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Παρακαλώ να θυμάστε αυτόν τον κωδικό πρόσβασης. Απαιτείται για πρόσβαση στον πίνακα διαχείρισης. Μπορείτε να τον αλλάξετε αργότερα.',
  INSTALLATION_COMPLETED: 'Η εγκατάσταση ολοκληρώθηκε.',
  INSTALLATION_COMPLETED_DESCRIPTION:
    'Η εγκατάσταση του OpenSupports ολοκληρώθηκε. Ανακατεύθυνση σε πίνακα διαχείρισης...',

  STEP_TITLE: 'Βήμα {current} από {total} - {title}',
  STEP_1_DESCRIPTION: 'Επιλέξτε τη γλώσσα που προτιμάτε για τον οδηγό εγκατάστασης.',
  STEP_2_DESCRIPTION:
    'Παρακάτω αναφέρονται οι απαιτήσεις για την εκτέλεση του OpenSupport. Βεβαιωθείτε ότι πληρούνται όλες οι απαιτήσεις.',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Αυτή είναι μια φόρμα για τη δημιουργία εισιτηρίων. Συμπληρώστε τη φόρμα και στείλτε μας τα θέματα / αμφιβολίες / προτάσεις σας. Το σύστημα υποστήριξης μας θα απαντήσει όσο το δυνατόν συντομότερα.',
  TICKET_LIST_DESCRIPTION:
    'Εδώ μπορείτε να βρείτε μια λίστα με όλα τα εισιτήρια που έχετε στείλει στην ομάδα υποστήριξης.',
  TICKETS_DESCRIPTION:
    'Στείλτε εισιτήριο μέσω του κέντρου υποστήριξης και λάβετε απάντηση από τις αμφιβολίες, τις προτάσεις και τα ζητήματά σας.',
  ARTICLES_DESCRIPTION: 'Ρίξτε μια ματιά στα άρθρα μας σχετικά με κοινά θέματα, οδηγούς και τεκμηρίωση.',
  ACCOUNT_DESCRIPTION:
    'Όλα τα εισιτήρια σας αποθηκεύονται στο προφίλ του λογαριασμού σας. Παρακολουθήστε όλα τα εισιτήρια που στέλνετε στην ομάδα του προσωπικού μας.',
  SUPPORT_CENTER_DESCRIPTION:
    'Καλώς ήλθατε στο κέντρο υποστήριξης μας. Μπορείτε να επικοινωνήσετε μαζί μας μέσω του συστήματος εισιτηρίων. Τα εισιτήρια σας θα απαντηθούν από το προσωπικό μας.',
  ...
  CUSTOM_TAGS_DESCRIPTION:
    'Εδώ μπορείτε να προβάλετε τη διαχείριση των προσαρμοσμένων ετικετών για τα εισιτήρια για να τα εντοπίσετε καλύτερα',
  ...
  TICKET_VIEW_DESCRIPTION:
    'Αυτό το εισιτήριο έχει αποσταλεί από έναν πελάτη. Εδώ μπορείτε να απαντήσετε ή να εκχωρήσετε το εισιτήριο',
  BAN_USERS_DESCRIPTION:
    'Εδώ μπορείτε να δείτε μια λίστα με απαγορευμένα μηνύματα ηλεκτρονικού ταχυδρομείου, μπορείτε να τα απενεργοποιήσετε ή να προσθέσετε περισσότερα μηνύματα ηλεκτρονικού ταχυδρομείου στη λίστα.',
  LIST_USERS_DESCRIPTION:
    'Αυτή είναι η λίστα των χρηστών που είναι εγγεγραμμένοι σε αυτήν την πλατφόρμα. Μπορείτε να αναζητήσετε κάποιον συγκεκριμένα, να τον διαγράψετε ή να τον απαγορεύσετε.',
  USER_VIEW_DESCRIPTION:
    'Εδώ μπορείτε να βρείτε όλες τις πληροφορίες σχετικά με ένα χρήστη και όλα τα εισιτήρια που στέλνει ο χρήστης. Μπορείτε επίσης να τα διαγράψετε ή να τα απαγορεύσετε.',
  DELETE_USER_DESCRIPTION:
    'Ο χρήστης δεν θα μπορέσει να συνδεθεί με τη γήρανση και όλα τα εισιτήρια του θα διαγραφούν. Επίσης, το ηλεκτρονικό ταχυδρομείο δεν μπορεί πλέον να χρησιμοποιηθεί.',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'Εδώ μπορείτε να προσθέσετε ένα άρθρο που θα είναι διαθέσιμο για κάθε χρήστη. Θα προστεθεί μέσα στην κατηγορία {category}.',
  LIST_ARTICLES_DESCRIPTION:
    'Αυτή είναι μια λίστα με άρθρα που περιλαμβάνουν πληροφορίες σχετικά με τις υπηρεσίες μας.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Ένα τμήμα είναι μια ομάδα όπου μπορούν να πάνε τα εισιτήρια. Χρησιμοποιούνται για την κατηγοριοποίηση των εισιτηρίων. Μπορείτε να τα αναθέσετε σε άλλα μέλη του προσωπικού.',
  MAINTENANCE_MODE_DESCRIPTION:
    'Το σύστημα υποστήριξης βρίσκεται σε κατάσταση συντήρησης, επομένως δεν είναι διαθέσιμο προς το παρόν. Θα επιστρέψουμε το συντομότερο δυνατό.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Εδώ μπορείτε να επεξεργαστείτε τα πρότυπα των μηνυμάτων ηλεκτρονικού ταχυδρομείου που θα αποστέλλονται στους χρήστες. Θυμηθείτε ότι τα διπλά άγκιστρα δείχνουν μια μεταβλητή τιμή. Για παράδειγμα, το 'όνομα ' αντιπροσωπεύει το όνομα του χρήστη",
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Εδώ μπορείτε να δημιουργήσετε λογαριασμό για το κέντρο υποστήριξης. Απαιτείται για την αποστολή εισιτηρίων και την προβολή της τεκμηρίωσης.',
  EDIT_PROFILE_VIEW_DESCRIPTION:
    'Εδώ μπορείτε να επεξεργαστείτε το χρήστη, αλλάζοντας την διεύθυνση ηλεκτρονικού ταχυδρομείου σας ή τον κωδικό πρόσβασης σας.',
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Ενεργοποίηση / απενεργοποίηση της χρήσης ενός συστήματος χρήστη. Εάν την απενεργοποιήσετε, όλοι οι χρήστες θα διαγραφούν αλλά τα εισιτήρια θα διατηρηθούν. Εάν την ενεργοποιήσετε, θα δημιουργηθούν οι χρήστες των υφιστάμενων εισιτηρίων.',
  CSV_DESCRIPTION:
    'Το αρχείο CSV πρέπει να έχει 3 στήλες: email, κωδικό πρόσβασης, όνομα. Δεν υπάρχει όριο στην καταμέτρηση των σειρών. Θα δημιουργηθεί ένας χρήστης ανά σειρά στο αρχείο.',
  SMTP_SERVER_DESCRIPTION:
    'Η διαμόρφωση του διακομιστή SMTP επιτρέπει στην εφαρμογή να στείλει μηνύματα. Αν δεν το ρυθμίσετε, δεν θα σταλούν μηνύματα ηλεκτρονικού ταχυδρομείου από το OpenSupport.',
  IMAP_SERVER_DESCRIPTION:
    'Η διαμόρφωση του διακομιστή IMAP επιτρέπει στην εφαρμογή να δημιουργεί εισιτήρια από τα μηνύματα ηλεκτρονικού ταχυδρομείου που αποστέλλονται σε ένα γραμματοκιβώτιο.',
  ...
  DISABLE_USER_DESCRIPTION:
    'Ο χρήστης θα απενεργοποιηθεί και δεν θα μπορέσει να συνδεθεί και να δημιουργήσει εισιτήρια.',
  ...
  EMAIL_SETTINGS_DESCRIPTION:
    'Εδώ μπορείτε να επεξεργαστείτε τις ρυθμίσεις για τη λήψη και αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου στους πελάτες σας.',
  IMAP_POLLING_DESCRIPTION:
    'Ο έλεγχος εισερχομένων δεν θα γίνει αυτόματα από το OpenSupport. Πρέπει να κάνετε τα αιτήματα POST περιοδικά σε αυτήν τη διεύθυνση url για να επεξεργαστείτε τα μηνύματα ηλεκτρονικού ταχυδρομείου: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Εδώ μπορείτε να δημιουργήσετε ένα προσαρμοσμένο πεδίο για έναν χρήστη, μπορεί να είναι ένα κενό πλαίσιο κειμένου ή ένα σταθερό σύνολο επιλογών.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Στα προσαρμοσμένα πεδία ορίζονται πρόσθετα πεδία που μπορούν να συμπληρώσουν οι χρήστες για να παρέχουν περισσότερες πληροφορίες σχετικά με αυτά.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Εδώ μπορείτε να προσκαλέσετε ένα χρήστη να συμμετάσχει σύστημα υποστήριξης μας, θα πρέπει απλά να παρέχει τον κωδικό του για να δημιουργήσετε ένα νέο χρήστη.',
  ...
  ERROR_RETRIEVING_BAN_LIST:
    'Ένα σφάλμα παρουσιάστηκε ενώ προσπαθούσαμε να ανακτήσουμε την λίστα των αποκλεισμένων διευθύνσεων ηλεκτρονικού ταχυδρομείου.',
  ERROR_BANNING_EMAIL:
    'Ένα σφάλμα παρουσιάστηκε ενώ προσπαθούσαμε να αποκλείσουμε την διεύθυνση ηλεκτρονικού ταχυδρομείου.',
  ...
  DEPARTMENT_PRIVATE_TICKETS:
    'Αυτό το τμήμα έχει εισιτήρια που δημιουργούνται από μη προσωπικό και δεν μπορεί να είναι ιδιωτικό',
  ...
  WILL_RECOVER_EMAIL_TEMPLATE:
    'Αυτό το πρότυπο ηλεκτρονικού ταχυδρομείου θα αναληφθεί σε κατάσταση αρχική με την αρχική γλώσσα.',
  ...
  DELETE_CUSTOM_FIELD_SURE:
    'Κάποιοι χρήστες ενδέχεται να χρησιμοποιούν αυτό το πεδίο. Είσαι σίγουρος οτι θέλεις να το διαγράψεις;',
  ...
  INSTANT: 'Στιγμή',
  INSTANT_DESCRIPTION:
    'Ποσοστό εισιτηρίων που έκλεισαν μετά από απάντηση ενός μόνο προσωπικού στο σύνολο των κλειστών εισιτηρίων',
