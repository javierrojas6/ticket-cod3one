export default {
  ...
  LEVEL_2_DESCRIPTION:
    'すべてのレベル1を行うことができ、記事を作成または編集したり、カスタムレスポンスを作成することができます。',
  LEVEL_3_DESCRIPTION:
    'すべてのレベル2を行うことができます、スタッフを作成または編集し、システム全体を管理することができます。',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'このパスワードを覚えておいてください。管理パネルにアクセスするために必要です。後で変更することができます。',
  ...
  STEP_2_DESCRIPTION:
    'ここにOpenSupportを実行するための要件が​​記載されています。すべての要件が満たされていることを確認してください。',
  ...
  CREATE_TICKET_DESCRIPTION:
    'これはチケットを作成するためのフォームです。 フォームに記入し、あなたに問題/疑問/提案をお送りください。私たちのサポートシステムは、できるだけ早くそれに答えるでしょう。',
  ...
  ACCOUNT_DESCRIPTION:
    'すべてのチケットはあなたのアカウントのプロフィールに保存されています。私たちのスタッフチームに送るすべてのチケットを追跡してください。',
  SUPPORT_CENTER_DESCRIPTION:
    'サポートセンターへようこそ。チケットシステムを通じてご連絡いただけます。あなたのチケットはスタッフによって返答されます。',
  ...
  TICKET_VIEW_DESCRIPTION:
    'このチケットは顧客によって送信されたものです。ここで、チケットに応答したり、チケットを割り当てることができます',
  BAN_USERS_DESCRIPTION:
    'ここでは、禁止された電子メールのリストを表示したり、電子メールの禁止を解除したり、電子メールを追加することができます。',
  LIST_USERS_DESCRIPTION:
    'これは、このプラットフォームに登録されているユーザーの一覧です。誰かを特に検索したり、削除したり、禁止することができます。',
  USER_VIEW_DESCRIPTION:
    'ここでは、ユーザーとユーザーが送信したすべてのチケットに関するすべての情報を見つけることができます。また、削除または禁止することもできます。',
  DELETE_USER_DESCRIPTION:
    'ユーザーはエージングできなくなり、すべてのチケットが消去されます。また、電子メールはこれ以上使用できません。',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'ここでは、すべてのユーザーが利用できる記事を追加できます。カテゴリ{category}の内側に追加されます。',
  ...
  DEPARTMENTS_DESCRIPTION:
    '部門とは、チケットが行くことができるグループのことです。それらはチケットを分類するために使用されます。それらを他のスタッフに割り当てることができます。',
  MAINTENANCE_MODE_DESCRIPTION:
    'サポートシステムはメンテナンスモードにあり、現時点では利用できません。私たちはできるだけ早く戻ってきます。',
  EMAIL_TEMPLATES_DESCRIPTION:
    'ここでは、ユーザーに送信される電子メールのテンプレートを編集できます。二重かっこの中括弧は変数値を示しています。たとえば、*name* はユーザーの名前を表します。',
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'ここでは、システムの詳細設定を変更できます。注意してください。変更は元に戻すことはできません。',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'サポートセンターのアカウントを作成できます。それはチケットを送るために必要であり、ドキュメンテーションを参照してください。',
  EDIT_PROFILE_VIEW_DESCRIPTION: 'ここでは、電子メールまたはパスワードを変更してユーザーを編集できます。',
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'ユーザシステムの使用を有効/無効にします。無効にすると、すべてのユーザーは削除されますが、チケットは保持されます。これを有効にすると、既存のチケットのユーザーが作成されます。',
  CSV_DESCRIPTION:
    'CSVファイルには、電子メール、パスワード、名前の3つの列が必要です。行数に制限はありません。ファイル内で行ごとに1人ずつ作成されます',
  SMTP_SERVER_DESCRIPTION:
    'SMTPサーバーの設定により、アプリケーションはメールを送信できます。 これを設定しないと、OpenSupportsから電子メールは送信されません。',
  IMAP_SERVER_DESCRIPTION:
    'IMAPサーバーの設定により、アプリケーションはメールボックスに送信されたEメールからチケットを作成できます。',
  ...
  IMAP_POLLING_DESCRIPTION:
    '受信トレイのチェックはOpenSupportsによって自動的には行われません。メールを処理するには、定期的にこのURLにPOSTリクエストを送信する必要があります：{url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'ここでは、ユーザー用のカスタムフィールドを作成できます。空白のテキストボックスまたは固定のオプションセットにすることができます。',
  CUSTOM_FIELDS_DESCRIPTION:
    'カスタムフィールドは、ユーザーがそれらについての詳細情報を提供するために入力できる追加のフィールドとして定義されます。',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'ここでは、私たちのサポートシステムに参加するユーザーを招待することができ、彼はちょうど新しいユーザーを作成するには、自分のパスワードを提供する必要があります。',
  ERROR_NAME: '名前が無効です',
