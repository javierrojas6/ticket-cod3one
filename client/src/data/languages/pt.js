export default {
  ...
  LEVEL_2_DESCRIPTION:
    'Pode fazer cada nível 1 faz, pode criar ou editar artigos e pode criar respostas personalizadas.',
  LEVEL_3_DESCRIPTION:
    'Pode fazer cada nível 2 faz, pode criar ou editar membros da equipe e pode gerenciar todo o sistema.',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'Lembre-se desta senha. É necessário para acessar o painel de administração. Você pode alterá-lo mais tarde.',
  INSTALLATION_COMPLETED: 'Instalação completa.',
  INSTALLATION_COMPLETED_DESCRIPTION:
    'A instalação do OpenSupports está concluída. Redirecionando para o painel de administração ...',

  STEP_TITLE: 'Passo {current} de {total} - {title}',
  STEP_1_DESCRIPTION: 'Selecione o idioma preferido para o assistente de instalação.',
  STEP_2_DESCRIPTION:
    'Aqui estão listados os requisitos para executar o OpenSupports. Certifique-se de que todos os requisitos estão satisfeitos.',
  ...
  CREATE_TICKET_DESCRIPTION:
    'Este é um formulário para criar ingressos. Preencha o formulário e envie-nos seus problemas / dúvidas / sugestões. Nosso sistema de suporte responderá o mais rápido possível.',
  TICKET_LIST_DESCRIPTION:
    'Aqui você pode encontrar uma lista de todos os ingressos enviados para nossa equipe de suporte.',
  TICKETS_DESCRIPTION:
    'Envie o seu bilhete através do nosso centro de apoio e obtenha resposta das suas dúvidas, sugestões e problemas.',
  ARTICLES_DESCRIPTION: 'Dê uma olhada em nossos artigos sobre questões comuns, guias e documentação.',
  ACCOUNT_DESCRIPTION:
    'Todos os seus bilhetes são guardados no perfil da sua conta. Mantenha um registo de todos os seus bilhetes que envia para a nossa equipa de funcionários.',
  SUPPORT_CENTER_DESCRIPTION:
    'Bem-vindo ao nosso centro de suporte. Pode contactar-nos através de um sistema de bilhetes. Os seus bilhetes serão respondidos pela nossa equipa.',
  ...
  BAN_USERS_DESCRIPTION:
    'Aqui você pode ver uma lista de e-mails proibidos, você pode un-ban-los ou adicionar mais e-mails para a lista.',
  LIST_USERS_DESCRIPTION:
    'Esta é a lista de usuários que estão registrados nesta plataforma. Você pode procurar alguém em particular, excluí-lo ou proibi-lo.',
  USER_VIEW_DESCRIPTION:
    'Aqui você pode encontrar todas as informações sobre um usuário e todos os bilhetes enviados pelo usuário. Você também pode excluí-lo ou proibi-lo.',
  DELETE_USER_DESCRIPTION:
    'O usuário não será capaz de entrar no envelhecimento e todos os seus bilhetes serão apagados. Além disso, o e-mail não pode mais ser usado.',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'Aqui você pode adicionar um artigo que estará disponível para cada usuário. Ele será adicionado dentro da categoria {category}.',
  ...
  DEPARTMENTS_DESCRIPTION:
    'Um departamento é um grupo onde os bilhetes podem ir. Eles são usados ​​para categorizar os ingressos. Você pode atribuí-los a outros membros da equipe.',
  MAINTENANCE_MODE_DESCRIPTION:
    'O sistema de suporte está em modo de manutenção, portanto indisponível no momento. Vamos voltar o mais rapidamente possível.',
  EMAIL_TEMPLATES_DESCRIPTION:
    "Aqui você pode editar os modelos dos e-mails que serão enviados aos usuários. Lembre-se que os colchetes duplos travessas indicam um valor variável. Por exemplo, 'name' representa o nome do usuário.",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'Aqui você pode alterar as configurações avançadas do seu sistema. Tenha cuidado, as alterações que você faz não podem ser revertidas.',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'Aqui você pode criar uma conta para o nosso centro de suporte. É necessário para enviar os bilhetes e ver a documentação.',
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'Ativar / desativar o uso de um sistema de usuário. Se você desativá-lo, todos os usuários serão excluídos, mas os ingressos serão mantidos. Se você ativá-lo, os usuários de tickets existentes serão criados.',
  CSV_DESCRIPTION:
    'O arquivo CSV deve ter 3 colunas: e-mail, senha, nome. Não há limite na contagem de linhas. Ele será criado um usuário por linha no arquivo.',
  SMTP_SERVER_DESCRIPTION:
    'A configuração do servidor SMTP permite que o aplicativo envie e-mails. Se você não configurá-lo, nenhum e-mail será enviado pela OpenSupports.',
  IMAP_SERVER_DESCRIPTION:
    'A configuração do servidor IMAP permite que o aplicativo crie tickets a partir dos emails enviados para uma caixa de correio.',
  ...
  IMAP_POLLING_DESCRIPTION:
    'A verificação da caixa de entrada não será feita automaticamente pelo OpenSupports. Você precisa fazer solicitações POST periodicamente para esse URL para processar os e-mails: {url}',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'Aqui você pode criar um campo personalizado para um usuário, pode ser uma caixa de texto em branco ou um conjunto fixo de opções.',
  CUSTOM_FIELDS_DESCRIPTION:
    'Campos personalizados são campos adicionais definidos que os usuários podem preencher para fornecer mais informações sobre eles.',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'Aqui você pode convidar um usuário para se juntar nosso sistema de suporte, ele só precisará fornecer sua senha para criar um novo usuário.',
  ...
  WILL_DELETE_DEPARTMENT:
    'O departamento será excluído. Todos os bilhetes serão transferidos para o departamento selecionado.',
  ...
  INSTANT: 'Instante',
  INSTANT_DESCRIPTION:
    'Porcentagem de tíquetes fechados após uma única resposta da equipe sobre o total de tíquetes fechados',
  REOPENED: 'Reaberta',
