...
class AreYouSure extends React.Component {
  ...
  static openModal(description, onYes, type = 'default') {
    ModalContainer.openModal(<AreYouSure description={description} onYes={onYes} type={type} />, {
      noPadding: true,
      closeButton: { showCloseButton: true, whiteColor: true }
    });
  }
  ...
  render() {
    ...
    return (
      <div
        ...
        role="dialog"
        aria-labelledby="are-you-sure__header"
        aria-describedby="are-you-sure__description">
