  ...
  render() {
    return (
      <div className="ticket-info">
        ...
        <div className="ticket-info__description">{htmlToText(this.props.ticket.content)}</div>
        ...
        <div className="ticket-info__properties">
          <div className="ticket-info__properties__status">
            <span className="ticket-info__properties__label">{i18n('STATUS')}:</span>
            <span className={this.getStatusClass()}>{this.props.ticket.closed ? 'closed' : 'open'}</span>
          </div>
          <div className="ticket-info__properties__owner">
            <span className="ticket-info__properties__label">{i18n('OWNED')}:</span>
            <span className={this.getOwnedClass()}>{this.props.ticket.owner ? i18n('YES') : i18n('NO')}</span>
          </div>
          <div className="ticket-info__properties__comments">
            <span className="ticket-info__properties__label">{i18n('COMMENTS')}:</span>
