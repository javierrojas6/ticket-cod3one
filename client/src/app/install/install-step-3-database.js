  ...
  render() {
    ...
    return (
      <div className="install-step-3">
        <Header
          title={i18n('STEP_TITLE', { title: i18n('DATABASE_CONFIGURATION'), current: 3, total: 6 })}
