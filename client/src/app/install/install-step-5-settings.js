  ...
  render() {
    ...
    return (
      <div className="install-step-5">
        <Header
          title={i18n('STEP_TITLE', { title: i18n('SETTINGS'), current: 5, total: 6 })}
        ...
        <Form
          ...
          <FormField
            className="install-step-5__attachments-field"
            name="allow-attachments"
            label={i18n('ALLOW_FILE_ATTACHMENTS')}
            field="checkbox"
          ...
          <div className="install-step-5__smtp-block">
            ...
            <SubmitButton
              className="install-step-5__test-connection"
              size="medium"
              onClick={this.onTestSMTPClick.bind(this)}
              disabled={loading}>
