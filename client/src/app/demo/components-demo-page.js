  ...
  elements: [
    {
      ...
      render: <Button type="primary">Sign up</Button>
    },
    {
      title: 'Tag selector',
      render: (
    ...
    {
      title: 'Input',
      render: <Input placeholder="placeholder" error="No anda" />
    },
    {
      title: 'Input wrapped in a label',
      render: <Input placeholder="placeholder" label="This is a label" icon="user" />
    },
    {
      title: 'Checkbox',
      render: <Checkbox label="Remember me" value={true} />
    },
    {
      title: 'Widget',
      render: (
    ...
    {
      title: 'Primary Menu',
      render: <Menu items={dropDownItems} />
    },
    {
      title: 'Secondary Menu',
      render: <Menu items={secondaryMenuItems} type="secondary" />
    },
    {
      title: 'Navigation Menu',
      render: <Menu items={secondaryMenuItems} type="navigation" />
    },
    {
      title: 'Horizontal Menu',
      render: <Menu items={secondaryMenuItems.slice(0, 3)} type="horizontal" />
    },
    {
      title: 'HorizontalList Menu',
      render: <Menu items={dropDownItems.slice(0, 3)} type="horizontal-list" />
    },
    {
      title: 'DropDown',
      render: (
        ...
        <Button
          onClick={function () {
            AreYouSure.openModal(
              'I confirm I want to perform this action.',
              () => {
                alert('yes');
              },
              'secure'
    ...
    },
    {
      ...
      render: (
        <Table
          ...
          comp={function (a, b) {
            let ans = 0;
            if (a.title1 < b.title1) ans = -1;
            else if (a.title1 > b.title1) ans = 1;
            return ans;
          }}
        />
      )
    ...
    {
      title: 'InfoTooltip',
      render: <InfoTooltip type="warning" text="No staff member is assigned to this department." />
    },
    {
      title: 'LineChart',
      // render: (
  ...
  render() {
    return (
      <DocumentTitle title="Demo Page">
        <section className="demo-page">{this.renderElements()}</section>
      </DocumentTitle>
    );
  },
    ...
    return this.elements.map((element) => {
      return (
        <div className="demo-element col-md-4">
          <h4>{element.title}</h4>
          <div className="demo-element--example">{element.render}</div>
        </div>
      );
    });
  }
