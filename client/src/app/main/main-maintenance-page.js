  ...
  render() {
    return (
      <div className="main-maintenance-page">
        ...
        <div className="main-maintenance-page__title">{i18n('MAINTENANCE_MODE')}</div>
        <div className="main-maintenance-page__description">{i18n('MAINTENANCE_MODE_DESCRIPTION')}</div>
      </div>
    );
  }
}
