      ...
      <div className="create-ticket-form">
        ...
        <Form {...this.getFormProps()}>
          ...
          <div className="create-ticket-form__container">
            <div
              className={`create-ticket-form__buttons-container${allowAttachments ? '' : '-without-allow-attachments'}`}>
              {allowAttachments ? this.renderFileUpload() : null}
              <SubmitButton type="secondary">{i18n('CREATE_TICKET')}</SubmitButton>
            </div>
            <div className="create-ticket-form__captcha-container">{!userLogged ? this.renderCaptcha() : null}</div>
          </div>
        </Form>
        {this.renderMessage()}
      </div>
