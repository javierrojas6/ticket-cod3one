...
class DashboardEditProfilePage extends React.Component {
          ...
          <div className="edit-profile-page__change-password-container">
            <div className="edit-profile-page__change-password-form-fields">
              ...
              <FormField
                ...
                label={i18n('REPEAT_NEW_PASSWORD')}
                field="input"
  ...
  renderCustomFields() {
    const { loadingCustomFields, customFieldsFrom, customFields } = this.state;
    ...
    return (
      <div className="edit-profile-page__edit-custom-field">
        ...
        <Form
          ...
          <div className="edit-profile-page__custom-fields">{customFields.map(this.renderCustomField.bind(this))}</div>
          <div className="edit-profile-page__update-custom-fields-button-container">
            <SubmitButton className="edit-profile-page__update-custom-fields-button" type="secondary">
