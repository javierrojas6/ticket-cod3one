...
class AdminPanelListUsers extends React.Component {
    ...
    return (
      <div className="admin-panel-list-users">
        ...
        {this.state.error ? (
          ...
          this.renderTableAndInviteButton()
        )}
      </div>
    );
  }
  ...
  renderTableAndInviteButton() {
    ...
    return (
      <div>
        <SearchBox
          className="admin-panel-list-users__search-box"
  ...
  getUserRow(user) {
    return {
      name: (
        <div>
          <Button
            className="admin-panel-list-users__name-link"
            type="link"
      ...
      email: user.email,
      tickets: <span className="admin-panel-list-users__tickets-number">{user.tickets}</span>,
  ...
  retrieveUsers(data) {
    ...
    API.call({
      ...
      .catch(this.onUsersRejected.bind(this))
