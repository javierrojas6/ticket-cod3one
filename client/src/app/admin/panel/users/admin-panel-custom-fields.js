...
class AdminPanelCustomFields extends React.Component {
    ...
    return (
      <div className="admin-panel-custom-fields">
        ...
        <div className="admin-panel-custom-fields__container-button">
          <Button
            className="admin-panel-custom-fields__container-button__add-button"
            type="secondary"
            onClick={this.onNewCustomFieldClick.bind(this)}>
  ...
  getCustomField(customField, index) {
    ...
    return {
      ...
      actions: (
        <Button size="medium" onClick={this.onDeleteCustomField.bind(this, id)}>
          Remove
        </Button>
      )
    };
