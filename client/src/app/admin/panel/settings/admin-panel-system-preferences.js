...
class AdminPanelSystemPreferences extends React.Component {
        ...
        <Form
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="admin-panel-system-preferences__maintenance">
                <span>
                  {i18n('MAINTENANCE_MODE')} <InfoTooltip text={i18n('MAINTENANCE_MODE_INFO')} />
                </span>
                <FormField
                  className="admin-panel-system-preferences__maintenance-field"
          ...
          <div className="row">
            <div className="col-md-6 admin-panel-system-preferences__form-fields">
              <FormField
                className="admin-panel-system-preferences__form-fields__input"
                label={i18n('SUPPORT_CENTER_URL')}
              ...
              />
              <FormField
                className="admin-panel-system-preferences__form-fields__select"
                label={i18n('SUPPORT_CENTER_LAYOUT')}
                fieldProps={{ size: 'large', items: [{ content: i18n('BOXED') }, { content: i18n('FULL_WIDTH') }] }}
                field="select"
                name="layout"
              />
            </div>
            <div className="col-md-6">
              <FormField
                label={i18n('SUPPORT_CENTER_TITLE')}
                fieldProps={{ size: 'large' }}
                name="title"
                validation="TITLE"
                required
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="row admin-panel-system-preferences__languages">
                <div className="col-md-6 admin-panel-system-preferences__languages-allowed">
                  <div>
                    {i18n('ALLOWED_LANGUAGES')} <InfoTooltip text={i18n('ALLOWED_LANGUAGES_INFO')} />
                  </div>
                  <FormField
                    name="allowedLanguages"
                    field="checkbox-group"
                    fieldProps={{ items: this.getLanguageList() }}
                    validation="LIST"
                    required
                  />
                </div>
                <div className="col-md-6 admin-panel-system-preferences__languages-supported">
                  <div>
                    {i18n('SUPPORTED_LANGUAGES')} <InfoTooltip text={i18n('SUPPORTED_LANGUAGES_INFO')} />
                  </div>
                  <FormField
            ...
            <div className="col-md-6">
              <FormField
                className="admin-panel-system-preferences__default-language-field"
                name="language"
                ...
                fieldProps={{
                  type: 'custom',
                  customList:
                    this.state.values.supportedLanguages && this.state.values.supportedLanguages.length
                      ? this.state.values.supportedLanguages.map((index) => languageKeys[index])
                      : undefined
                }}
              />
              ...
              <div className="admin-panel-system-preferences__file-attachments">
                ...
                <FormField
                  className="admin-panel-system-preferences__file-attachments-field"
              ...
              <div className="admin-panel-system-preferences__max-size">
                ...
                <FormField
                  className="admin-panel-system-preferences__max-size-field"
          ...
          <div className="row admin-panel-system-preferences__container">
            <div className="col-md-4 col-md-offset-2">
              <Button
                className="admin-panel-system-preferences__container__button"
                onClick={this.onDiscardChangesSubmit.bind(this)}>
                {i18n('DISCARD_CHANGES')}
              </Button>
            </div>
            <div className="col-md-4">
              <SubmitButton className="admin-panel-system-preferences__container__button" type="secondary">
  ...
  onFormChange(form) {
    ...
    const updatedSupportedLanguages = _.filter(supportedLanguages, (supportedIndex) =>
      _.includes(allowedLanguages, supportedIndex)
    );

    this.setState({
      values: _.extend({}, form, {
        language: _.includes(updatedSupportedLanguages, languageIndex)
          ? language
          : languageKeys[updatedSupportedLanguages[0]],
  ...
  onSubmit(form) {
    ...
    API.call({
      ...
      .catch(() => this.setState({ loading: false, message: 'fail', showMessage: true }));
  }
  ...
  recoverSettings() {
    API.call({
      ...
      .catch(this.onRecoverSettingsFail.bind(this));
  }
