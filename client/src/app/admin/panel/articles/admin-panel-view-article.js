...
class AdminPanelViewArticle extends React.Component {
  ...
  render() {
    return <div className="admin-panel-view-article">{this.props.loading ? <Loading /> : this.renderContent()}</div>;
  }
    ...
    return (
      <Form
        ...
        <div className="admin-panel-view-article__buttons">
          ...
          <SubmitButton className="admin-panel-view-article__button" type="secondary" size="medium">
            {i18n('SAVE')}
          </SubmitButton>
        </div>
