  ...
  render() {
    ...
    return (
      <div className="admin-panel-stats">
        ...
        <Form
          className="admin-panel-stats__form"
          loading={loading}
          values={rawForm}
            ...
            <div className="admin-panel-stats__form__container__row">
              <div className="admin-panel-stats__form__container__col">
                ...
                <FormField
                  ...
                  label={i18n('TAGS')}
                  field="tag-selector"
                  fieldProps={{ items: this.getTagItems() }}
                />
              </div>
              <div className="admin-panel-stats__form__container__col">
                <FormField
                ...
                <FormField
                  ...
                  label={i18n('OWNER')}
                  field="autocomplete"
                  fieldProps={{ items: this.getStaffItems() }}
                />
              </div>
            </div>
          </div>
        ...
        {loading || !statsRenderer ? (
          <div className="admin-panel-stats__loading">
            <Loading backgrounded size="large" />
          </div>
        ) : (
          statsRenderer.renderStatistics({
            showStatCards: true,
            showStatsByHours: true,
            showStatsByDays: true,
            ticketData
          })
        )}
      </div>
