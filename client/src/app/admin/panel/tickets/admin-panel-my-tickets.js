...
class AdminPanelMyTickets extends React.Component {
  ...
  render() {
    return (
      <div className="admin-panel-my-tickets">
        ...
        <div className="admin-panel-my-tickets__actions">
  ...
  getProps() {
    ...
    const { userId, departments, tickets, loading, pages, page } = this.props;
    ...
    ModalContainer.openModal(
      <div className="admin-panel-my-tickets__create-ticket-form-container">
        ...
        <div className="admin-panel-my-tickets__close-button-container">
          <Button className="admin-panel-my-tickets__close-button" onClick={ModalContainer.closeModal} type="link">
            {i18n('CLOSE')}
          </Button>
        </div>
      </div>
  ...
  retrieveMyTickets({
    ...
    closed = this.state.closedTicketsShown,
